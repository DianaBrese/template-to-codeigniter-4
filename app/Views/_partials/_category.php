            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="post-entry-1 border-bottom">
                        <a href="single-post.html"><img src="<?php echo $posts[1]->image ?>" alt=""
                                class="img-fluid"></a>
                        ...
                        <h2 class="mb-2"><a href="single-post.html"><?php echo $posts[1]->title ?></a>
                        </h2>
                ...
                <div class="col-lg-8">
                    <div class="post-entry-1">
                        <a href="single-post.html"><img src="<?php echo $posts[3]->image ?>" alt=""
                                class="img-fluid"></a>
